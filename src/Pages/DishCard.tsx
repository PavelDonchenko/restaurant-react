...
function DishCard() {
  const { id } = useParams();
  const [dish, setDish] = React.useState<Items>();
  ...
  React.useEffect(() => {
    async function fetchDish() {
      try {
        const dishData = await axios.get(
          `https://62ba0099ff109cd1dc9f5a3f.mockapi.io/dishes/${id}`
        );
      ...
      <div className="card__container">
          ...
          <div className="card__title">
            ...
            >
              <circle
                ...
                cy="13"
                r="13"
                fill="url(#paint0_linear_9072_1137)"
              />
              <path
        ...
        <div className="card__item item-card">
          <div className="item-card__image-ibg">
            <a>
              <img
                className="item-card__arrow-hiden"
                src={arrowIcon}
                alt="icon"
              />
            </a>
          ...
          <div className="item-card__description description-card">
            ...
            <p className="description-card__text">{dish.text}</p>
            ...
            <div className="description-card__backet">
              <button
                ...
                className="description-card__btn"
              >
                Корзина
              </button>
