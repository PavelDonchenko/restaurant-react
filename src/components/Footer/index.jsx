        ...
        <footer className="footer">
            <div className="footer__container">
                ...
                <div className="footer__logo logo-wrapper">
                    ...
                    <p className="logo-wrapper__copyright">© ООО СК «АПШЕРОН» <br />Все права защищены. 2010-2020</p>
                    <div className="footer-logo-link">
                        <a href="#" className="logo-wrapper__agreement">Пользовательское соглашение</a>
                        <a href="#" className="logo-wrapper__mapt">Карта сайта</a>
                        <a href="#" className="logo-wrapper__confidential">Политика конфиденциальности</a>
                    </div>
                </div>
