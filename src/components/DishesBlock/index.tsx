...
const DishesBlock: React.FC<DishesBlockProps> = ({
  id,
  imageUrl,
  title,
  text,
    ...
    <div className="dish__slide slide-dish swiper-slide">
      ...
      <div className="slide-dish__subscribe subscribe-dish">
        ...
        <div className="subscribe-dish__footer footer-subscribe">
          <div className="footer-subscribe__price">
            {addedCount <= 1 ? price : price * addedCount} грн.
          </div>
          <button type="submit" className="footer-subscribe__basket btn">
            В корзину
          </button>
          <div data-quantity className="quantity">
            ...
            <button
              onClick={() => addedCount && addedCount > 0 && onClickMinus()}
              data-quantity-minus
              type="button"
