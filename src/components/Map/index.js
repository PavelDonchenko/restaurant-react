    ...
    return (
        <section className="map">
            <div className="map__container">
                <div className="map__contacts contacts-map">
                    <div className="contacts-map__title title-two">КОНТАКТЫ</div>
                    <div className="contacts-map__adress adress-map">
                        <div className="adress-map__title">Наш адресс:</div>
                        <div className="adress-map__text">МО, городской округ Красногорск, село Ильинкое, Экспериментальная улица, 10</div>
                    </div>
                    <div className="contacts-map__post post-map">
                        <div className="post-map__title">Наша почта:</div>
                        <div className="post-map__text">auto.wash@gmail.com</div>
                    </div>
                    <div className="contacts-map__phone phone-map">
                        <button type="submit" className="phone-map__button">ЗАБРОНИРОВАТЬ СТОЛ</button>
                        ...
                        <div className="phone-map__tel tel-phone">
                            ...
                            <div className="tel-phone__text">Звоните или оставляйте заявку</div>
                        </div>
                    </div>
                    <div className="contacts-map__social social-map">
                        <span className="social-map__title">Мы в соц сетях:</span>
                        <a href="#!" className="social-map__item _icon-facebook">
                        ...
                        <a href="#!" className="social-map__item _icon-vkontakte">
                        ...
                        <a href="#!" className="social-map__item _icon-youtube">
                            <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#!" className="social-map__item _icon-instagram">
                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="map__location"><img src={marker} alt="Маркер мы тут" /></div>
            </div>
        </section>
    )
}
