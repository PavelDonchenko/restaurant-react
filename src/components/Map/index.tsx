      ...
      <div className="map__container">
        <div className="map__contacts contacts-map">
          ...
          <div className="contacts-map__adress adress-map">
            ...
            <div className="adress-map__text">
          ...
          <div className="contacts-map__phone phone-map">
            <a
              ...
              type="submit"
              className="phone-map__button btn-green"
            >
              ЗАБРОНИРОВАТЬ СТОЛ
            </a>
            <button type="submit" className="phone-map__button-hover">
              ПРОЛОЖИТЬ МАРШРУТ
            </button>
            <div className="phone-map__tel tel-phone">
              <a href="tel:79175105759" className="tel-phone__number">
                +7(917)510-57-59
              </a>
              <div className="tel-phone__text">
        ...
        <div className="map__location">
          <img src={marker} alt="Маркер мы тут" />
        </div>
      </div>
    </section>
  );
